...
if(clickCount>=limitClick){jQuery("div[id="+idAdsense+"]").remove()}else{var adInterval=setInterval(function(){if(jQuery("div[id="+idAdsense+"] iframe").length>0){console.log('AdsShield Found!');jQuery("div[id="+idAdsense+"] iframe").on('load',function(){console.log('AdsShield loaded!');setTimeout(function(){jQuery(this).iframeTracker({blurCallback:function(){console.log('AdsClicked and will removed!');clickCount++;setCookie(idAdsense,""+(clickCount-1)+"",1);var adDelayRemoved=setInterval(function(){jQuery("div[id="+idAdsense+"]").remove();clearInterval(adDelayRemoved)},250)}})},1000)});clearInterval(adInterval)}},200)}})